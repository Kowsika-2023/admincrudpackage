      ...
      <div class="block-header">
         ...
         <div class="block-content block-content-full">
            ...
            <!-- Name -->
              ...
              <label>Name</label>
                <input type="text"   name="name"   required  value="{{ old('name') }}" class="form-control form-control-lg"
              ...
              <div class="form-outline mb-4 col-8">
              <label>Mobile</label>
                <input type="text"   name="mobile"     value="{{ old('mobile') }}" class="form-control form-control-lg"
                  placeholder="Enter Name" />
              </div>

              <div class="form-outline mb-4 col-8">
              <label>Password</label>
                <input type="text"   name="password"     value="{{ old('password') }}" class="form-control form-control-lg"
                  placeholder="Enter Name" />
              </div>
